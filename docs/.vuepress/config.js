module.exports = {
  ...
  port: '8800',  // 生成网页端口（本地调试使用）
  title: "水中鱼、何寻觅", // 显示在左上角的网页名称以及首页在浏览器标签显示的title名称
  ...
  themeConfig: {
    ...
    nav: [
      ...
      { text: "时间线", link: "/timeline/", icon: "reco-date" },
      {
        ...
        items: [
          {
            text: "GitHub",
            link: "https://github.com/yshaotao",
            icon: "reco-github"
          },
          // {
          //   text: "CSDN",
    ...
    // recordLink: "https://icp.chinaz.com/tsanfer.xyz", // 备案信息
